...
structure TreeTypes =
  ...
  (* the layout of a vector onto target-supported vectors. *)
    ...
    datatype t
      ...
      | FEMSrcTy  (*PDE solution *)| BasisDataTy  (*Data from PDE solution *)
      | polyTy |coordTy | fcTy
      | jacobiansTy | JITy | transformsTy
      | MappTy of t * t (*Mapp of one type to another*)
      | arrTy of t (* list of types*)
      | FemFldTy | MeshTy | ElementTy | FnSpaceTy | optStruct
  ...
  (* is a source type compatible with the destination type? *)
    ...
    fun toString BoolTy = "bool"
      ...
      | toString(FEMSrcTy) ="PDE solution"
