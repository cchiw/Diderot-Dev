...
(* QUESTION: should we include precision info for IntTy and TensorTy? *)
...
(* FIXME: factor out the common part of this translation in GenLibraryInterface *)
                            val outTy = (case ty
                                   of Ty.BoolTy => CL.T_Ptr(GenLib.toCType(env, ty))
                                    | Ty.StringTy => CL.T_Ptr(GenLib.toCType(env, ty))
