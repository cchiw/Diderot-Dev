...
(BV.curl3D_p,             simpleEOp Mk.curl3d),
                ...
                (BV.fn_concat_ft2,       fn (y, [_, Ty.DIM d1,  Ty.DIM dd1, Ty.DIM dd2], xs) =>
                                                [assignEin(y, (Mk.concatField(d1, [dd1,dd2],2)), xs)]),
                (BV.fn_concat_fs3,       fn (y, [_, Ty.DIM d1], xs) =>
                                            [assignEin(y, (Mk.concatField(d1, [],3)), xs)]),
                (BV.fn_concat_fm3,       fn (y, [_, Ty.DIM d1, Ty.DIM dd1], xs) =>
...
[assignEin(y, Mk.inv2F dim, xs)]),
            ...
            (BV.fn_inv3_p,          fn (y, [_, Ty.DIM dim], [x]) => let
                ...
                (BV.fn_comp_t,          fn (y,[Ty.SHAPE dd0, Ty.SHAPE dd1],xs) =>
                                            [assignEin(y, Mk.compositionT(dd0, dd1), xs)]),
                (BV.op_comp_t,          fn (y,[Ty.SHAPE dd0, Ty.SHAPE dd1],xs) =>
                                            [assignEin(y, Mk.compositionT(dd0, dd1), xs)]),
                (BV.fn_comp_f,          fn (y,[_,Ty.DIM d1, Ty.DIM d2, Ty.SHAPE dd0, Ty.SHAPE dd1],xs) =>
                                          [assignEin(y, Mk.compositionF(dd0, dd1, d1), xs)]),
                (BV.op_comp_f,          fn (y,[_,Ty.DIM d1, Ty.DIM _, Ty.SHAPE dd0, Ty.SHAPE dd1],xs) =>
                                         [assignEin(y, Mk.compositionF(dd0, dd1, d1), xs)]),
                (BV.fn_comp_p,          fn (y,[_,Ty.DIM d1, Ty.DIM _, Ty.SHAPE dd0, Ty.SHAPE dd1],xs) =>
                                        [assignEin(y, Mk.compositionF(dd0, dd1, d1), xs)]),
                (BV.op_comp_p,          fn (y,[_,Ty.DIM d1, Ty.DIM d2, Ty.SHAPE dd0, Ty.SHAPE dd1],xs) =>
                                        [assignEin(y, Mk.compositionF(dd0, dd1, d1), xs)]),
...
*)
		...
		(BV.fn_convert_Tracker_rm,      fn (y, [_,Ty.DIM d, Ty.SHAPE dd], [f,s,r]) =>
                ...
                (BV.fn_inside, fn (y, [_,Ty.DIM d, Ty.SHAPE dd], xs) =>
                                                assign(y, Op.InsideBASE d, xs)),
                (BV.ms_USq,                     fn (y, _, xs) =>
						   assign(y, Op.BuildMesh (ME.UnitSquareMesh), xs)),
		(BV.ms_UCq,                     fn (y, _, xs) =>
						   assign(y, Op.BuildMesh (ME.UnitCubeMesh), xs)),
                (BV.re_Lagrange,                     fn (y, _, xs) =>
                        assign(y, Op.BuildElement (ME.Lagrange), xs)),
                (BV.re_P,                     fn (y, _, xs) =>
                        assign(y, Op.BuildElement (ME.P), xs)),
                (BV.fn_functionspace,           fn (y, _, xs) =>
						   assign(y, Op.BuildSpace, xs)),
		(BV.fn_tensorfunctionspace,           fn (y, _, xs) =>
						   assign(y, Op.BuildSpace, xs)),
                (BV.fn_swap2,               fn (y, [_,Ty.DIM d, Ty.SHAPE dd], xs) =>
                                            [assignEin(y, Mk.swap(d, dd, 2), xs)]),
                (BV.fn_swap3,               fn (y, [_,Ty.DIM d, Ty.SHAPE dd], xs) =>
                                            [assignEin(y, Mk.swap(d, dd, 3), xs)]),
                (BV.fn_swap4,               fn (y, [_,Ty.DIM d, Ty.SHAPE dd], xs) =>
                                            [assignEin(y, Mk.swap(d, dd, 4), xs)]),
                (BV.fn_swap5,               fn (y, [_,Ty.DIM d, Ty.SHAPE dd], xs) =>
                                            [assignEin(y, Mk.swap(d, dd, 5), xs)]),
