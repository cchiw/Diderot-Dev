...
(case ty
(*FEM field source *)
of Ty.FemFldTy => CL.T_Named (*("void *")*) ("FEMSrcTy")

(*FEM data types*)
| Ty.BasisDataTy  => CL.T_Named ("BasisDataTy")
| Ty.polyTy => CL.T_Named ("polyTy")
| Ty.coordTy => CL.T_Named ("coordTy")
| Ty.fcTy=> CL.T_Named ("fcTy")
| Ty.jacobiansTy => CL.T_Named ("jacobiansTy")
| Ty.JITy => CL.T_Named ("JITy")
| Ty.transformsTy => CL.T_Named ("transformsTy")
| Ty.MappTy(e1,Ty.VecTy(1,1)) => CL.T_Named ("FloatMapTy")
| Ty.MappTy(e1,e2)=> CL.T_Named ("MappTy")
| Ty.optStruct => CL.T_Named ("optStruct")
| _ => raise Fail ("Missing type for :"^Ty.toString(ty))
(* end case *))
